 ...
 * Use the [informasi.newInstance] factory method to
 * create an instance of this fragment.
 */
class informasi : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.tombol.setOnClickListener{
            findNavController().navigate(R.id.action_informasi_to_sheet)
